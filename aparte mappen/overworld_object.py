...
class OverworldObjectView():
    ...
    SPRITE_WIDTH = SPRITE_HEIGHT = None
    ...
    def _load_object_sprite_sheets(self, sprite_width, sprite_height):
        ...
        # images = [file for file in listdir(self.asset_folder) if isfile(join(self.asset_folder, file))]
    ...
    def update_sprite(self, obj_state: str, ani_count: int = None, direction = False) -> pygame.image:
